...
- Kickoff command: `claude --append-system-prompt-file program.md "Start the optimization loop."`
...
```bash
cd {output_dir}
claude --append-system-prompt-file program.md "Start the optimization loop."
```
